  ...
  <el-card>
    ...
    <el-footer>
      <div style="display: inline">
        <el-button type="warning" @click="handleDataReject">驳回</el-button>
        <el-button type="info" @click="handleDataSave">保存</el-button>

        <el-button style="display;: right" type="success" @click="submitUpload"
          >提交</el-button
        >
      </div>
    </el-footer>
      ...
      dataList: [
        {
          ...
          explanation: "北大文学",
          value: "4",
          material: "https://picsum.photos/200/200",
