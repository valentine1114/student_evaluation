      ...
      <div class="login-form">
        ...
        <el-form ref="form" :model="loginForm" :rules="rules" label-position="left" label-width="0">
          <el-form-item prop="studentID">
            <el-input v-model="loginForm.studentId" placeholder="请输入用户名"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="do_login" :loading="loading">登录</el-button>
            <el-button type="primary" @click="do_goback" :loading="loading">返回</el-button>
             </el-form-item>
        </el-form>
      </div>
  </template>
    ...
    methods: {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          login(this.loginForm.studentId).then(res =>{
